...
if (!html.includes("cp-rosters.js?v=20260826-exit-ticket") || !html.includes("app.js?v=20260915-test-resource-colors") || !html.includes("styles.css?v=20260915-test-resource-colors-2")) errors.push("Exit-ticket cache versions are not current.");
