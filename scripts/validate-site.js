...
if (!html.includes("styles.css?v=20260915-test-resource-colors") || !html.includes("app.js?v=20260915-test-resource-colors") || !html.includes("course-data.js?v=20260915-test-resource-colors") || !html.includes("foundations-data.js?v=20260823-unit-1-launch")) {
...
if (!html.includes("cp-rosters.js?v=20260826-exit-ticket") || !html.includes("app.js?v=20260915-test-resource-colors") || !html.includes("styles.css?v=20260915-test-resource-colors")) errors.push("Exit-ticket cache versions are not current.");
