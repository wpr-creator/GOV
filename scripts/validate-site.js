...
if (!html.includes("styles.css?v=20260909-ticket-confirmation") || !html.includes("app.js?v=20260909-ticket-confirmation") || !html.includes("course-data.js?v=20260908-politics-definition") || !html.includes("foundations-data.js?v=20260823-unit-1-launch")) {
...
if (!html.includes("cp-rosters.js?v=20260826-exit-ticket") || !html.includes("app.js?v=20260909-ticket-confirmation") || !html.includes("styles.css?v=20260909-ticket-confirmation")) errors.push("Exit-ticket cache versions are not current.");
...
if (appCode.includes('mode: "no-cors"') || !appCode.includes('(await result.json()).result !== "success"')) errors.push("Exit tickets must require a confirmed save response.");
