...
for (const marker of ["THE ROOT", "MAKE THE CONNECTION", "THE U.S. TODAY", "CHOOSE ONE CONNECTED IDEAL", "WHAT THIS MEANS IN THE U.S.", "prefers-reduced-motion"]) {
...
if (!rootsPracticeHtml.includes("20260901-simplified") || rootsPracticeHtml.includes("phrase-bank") || rootsPracticeHtml.includes("CHECK MY CONNECTION")) errors.push("Root Connections must use the simplified one-ideal-at-a-time version.");
