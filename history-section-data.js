window.HISTORY_SECTION_DATA = {
  independence: {
    ...
    sections: [
      { notesCue: "1776 paragraph · rights", heading: "NATURAL RIGHTS", text: "People are born with basic rights. Government does not create these rights. Its job is to protect them." },
      { notesCue: "1776 paragraph · power from the people", heading: "POWER FROM THE PEOPLE", text: "Government receives its authority from the people. This is popular sovereignty and consent of the governed." },
      { notesCue: "1776 paragraph · changing government", heading: "LIMITED GOVERNMENT", text: "Government may not use power however it wants. When it repeatedly violates rights, the people may change or replace it." },
      { notesCue: "The Central Problem", heading: "THE IMPORTANT QUESTION", text: "After rejecting British rule, Americans had to create a government strong enough to work without creating another tyranny." }
    ],
  ...
  articles: {
    ...
    sections: [
      { notesCue: "Opening paragraph", heading: "WHY DID STATES KEEP MOST POWER?", text: "Each state saw itself as independent and wanted to control its own laws, taxes, and economy. Americans also wanted to prevent a new central government from becoming like the British monarchy." },
      { notesCue: "Congress Could", heading: "WHAT COULD CONGRESS DO?", bullets: ["Declare war and make peace", "Make treaties with other countries", "Coin, or produce, money", "Manage relations with other nations and Native nations", "Ask states for soldiers and money"] },
      { notesCue: "Congress Could Not", heading: "HOW WAS IT ORGANIZED?", bullets: ["Congress was the only national branch.", "There was no president to enforce national decisions.", "There was no national court system to settle disputes.", "Every state received one vote, whether its population was large or small.", "Nine of thirteen states had to approve major laws. All thirteen had to approve an amendment."] },
      { notesCue: "The tradeoff · The result", heading: "THE TRADEOFF", text: "The Articles protected state power and made another national ruler less likely. The tradeoff was a national government that depended on the states and could not solve many problems on its own." }
    ],
  ...
  crisis: {
    ...
    sections: [
      { notesCue: "Five visible failures", heading: "FIVE FAILURES PEOPLE COULD SEE", bullets: ["Taxes: Congress could ask states for money but could not require payment.", "Trade: States taxed one another’s goods, while Congress could not create one national trade policy.", "Enforcement: Congress could make decisions but had no executive branch to carry them out.", "Courts: No national judicial branch existed to settle disputes between states.", "Money: States issued different currencies, making trade and debt harder to manage."] },
      { notesCue: "Economic Problems · Shays’ Rebellion", heading: "SHAYS’ REBELLION", text: "In Massachusetts, many farmers could not pay high taxes and private debts after the Revolutionary War. Courts could take their farms or send them to debtors’ prison. Daniel Shays, a former Continental Army captain, joined armed farmers who closed courthouses so judges could not hear debt cases. In 1787, a privately funded Massachusetts force stopped the uprising." },
      { notesCue: "Government Problems · Shays’ Rebellion", heading: "WHAT DID THE REBELLION PROVE?", text: "The state eventually restored order, but Congress could not quickly raise money or troops to help. To many national leaders, this showed that the government might be unable to respond during a serious emergency. Others still worried that a stronger government could use force against ordinary people." },
      { notesCue: "The larger lesson", heading: "THE DEEPER LESSON", text: "Liberty can be threatened by a government that is too powerful. It can also be threatened when government is too weak to protect rights, property, public safety, or the rule of law." }
    ],
  ...
  convention: {
    ...
    sections: [
      ...
      { notesCue: "Constitutional Response", heading: "THE THREE-BRANCH RESPONSE", bullets: ["Article I created Congress to make federal laws.", "Article II created the presidency to enforce federal laws.", "Article III created a federal judiciary to interpret laws and settle cases."] },
      { notesCue: "Limit on the New Power", heading: "HOW DID THEY LIMIT THE NEW GOVERNMENT?", text: "Separation of powers gave different jobs to different branches. Checks and balances allowed each branch to limit certain actions of the others. Federalism divided power between the national and state governments. Elections made officials responsible to the people." },
      { notesCue: "Final paragraph · useful power with limits", heading: "THE DESIGN PROBLEM", text: "The delegates believed people need government because communities need laws and order. They also believed people who hold office may misuse power. The Constitution therefore gives government real authority while placing barriers between leaders and absolute power." }
    ],
  ...
  compromises: {
    ...
    sections: [
      ...
      { notesCue: "Section 5 add-on", heading: "COMPROMISES OVER SLAVERY", text: "Southern delegates wanted enslaved people counted when representation was assigned, even though enslaved people could not vote and had no political rights. The Three-Fifths Compromise counted every five enslaved people as three people for representation and direct taxes, increasing slave states’ political power. Another compromise prevented Congress from banning the international slave trade before 1808. These agreements protected slavery rather than resolving its injustice." },
      { notesCue: "Section 5 add-on", heading: "THE ELECTORAL COLLEGE", text: "Delegates disagreed about whether Congress or voters should select the president. They created a system in which each state appoints electors who formally choose the president. This system combined state influence, population, and an indirect public vote." },
      { notesCue: "The Amendment Process · Article V table", heading: "THE AMENDMENT PROCESS", text: "Under the Articles, every state had to approve a change. Article V created a process that is still difficult but does not require complete agreement. An amendment needs broad support at both the national and state levels." }
    ],
  ...
  debate: {
    ...
    sections: [
      { notesCue: "Opening paragraph · ratify", heading: "THE CONSTITUTION NEEDED APPROVAL", text: "The delegates signed the Constitution, but that did not make it law. Special conventions in at least nine states had to ratify, or formally approve, it. Federalists and Anti-Federalists tried to persuade the people through speeches, newspapers, pamphlets, and public meetings." },
      { notesCue: "Federalists column", heading: "THE FEDERALIST ARGUMENT", text: "Federalists supported ratification. They said the Articles proved that the country needed a government able to tax, regulate trade, enforce laws, provide defense, and solve national problems. In Federalist No. 10, James Madison argued that a large republic would contain many competing factions, making it harder for one group to control the whole government." },
      { notesCue: "Anti-Federalists column", heading: "THE ANTI-FEDERALIST ARGUMENT", text: "Anti-Federalists opposed the Constitution or demanded changes. They feared that a distant national government would weaken the states and expand its own power. In Brutus No. 1, an author using the name Brutus warned that a very large republic would be too distant from ordinary citizens. Anti-Federalists also demanded a clear list of protected rights." },
      { notesCue: "Compare both columns", heading: "THE SAME GOAL, DIFFERENT FEARS", text: "Both sides wanted to protect liberty and prevent tyranny. Federalists feared a government too weak to act. Anti-Federalists feared a national government powerful enough to abuse rights. They disagreed about which danger was greater." }
    ],
  ...
  rights: {
    ...
    sections: [
      ...
      { notesCue: "1789 row · James Madison", heading: "A PROMISE OF PROTECTED RIGHTS", text: "Anti-Federalists had warned that the Constitution did not clearly protect individual rights. To gain support for ratification, Federalists promised that the new Congress would consider amendments. In 1789, James Madison introduced amendments based partly on protections requested by the states." },
      { notesCue: "1791 row · Bill of Rights", heading: "THE BILL OF RIGHTS", text: "In 1791, the states ratified ten amendments known as the Bill of Rights. They protect freedoms such as religion, speech, press, assembly, and petition. They also protect people accused of crimes and place rules on searches, punishments, and government use of private property." },
      { notesCue: "Final paragraph · who the rights limit", heading: "WHO MUST FOLLOW THESE RIGHTS?", text: "At first, the Bill of Rights limited only the federal government. It did not automatically apply to state or local governments. After the Fourteenth Amendment was ratified in 1868, the Supreme Court gradually required states and local governments to follow most Bill of Rights protections too." }
    ],
