window.HISTORY_SECTION_DATA = {
  ...
  crisis: {
    ...
    bigIdea: "The national government had responsibilities, but it did not have enough power or dependable money to meet them.",
    ...
    teach: ["The difference between having a responsibility and having power to carry it out", "At least three weaknesses of the Articles", "What happened during Shays’ Rebellion", "Why people reached different conclusions about the rebellion"]
  },
  convention: {
    ...
    bigIdea: "The delegates replaced the Articles with a stronger national system, then divided power to keep that system from becoming a tyranny.",
    ...
    sections: [
      { heading: "WHAT NEEDED TO CHANGE?", bullets: ["Congress needed dependable tax revenue.", "The country needed one system for trade between states and with other nations.", "Someone needed to enforce federal laws.", "National courts were needed to settle disputes and interpret federal law.", "The national government needed authority over states when states ignored valid national decisions."] },
      { heading: "THE THREE-BRANCH RESPONSE", bullets: ["Article I created Congress to make federal laws.", "Article II created the presidency to enforce federal laws.", "Article III created a federal judiciary to interpret laws and settle cases."] },
    ...
    teach: ["Why the delegates replaced instead of repaired the Articles", "What each of the three branches does", "How the Constitution made government stronger", "How separation of powers, checks and balances, and federalism limit power"]
  },
  compromises: {
    ...
    bigIdea: "The Constitution could not have been completed without compromises, but compromise did not make every result equal or just.",
    ...
    sections: [
      ...
      { heading: "THE ELECTORAL COLLEGE", text: "Delegates disagreed about whether Congress or voters should select the president. They created a system in which each state appoints electors who formally choose the president. This system combined state influence, population, and an indirect public vote." },
    ...
    teach: ["What disagreement each compromise tried to settle", "How the Great Compromise created today’s Congress", "How compromises increased or protected slave-state power", "Why a political compromise can work as an agreement and still be unjust"]
  },
  debate: {
    ...
    bigIdea: "Both sides wanted to protect liberty, but they disagreed about whether weak government or powerful government was the greater danger.",
    ...
    teach: ["Why nine states had to ratify the Constitution", "The strongest Federalist argument", "The strongest Anti-Federalist argument", "What Federalist No. 10 and Brutus No. 1 added to the debate", "The concern both sides shared"]
  },
  rights: {
    ...
    bigIdea: "The Constitution created a stronger government, and the Bill of Rights added specific protections against that government’s power.",
    ...
    teach: ["What happened in 1788, 1789, and 1791", "Why Federalists promised amendments", "Examples of rights protected by the first ten amendments", "How the final result included ideas from both sides"]
  }
};
