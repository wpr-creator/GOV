window.HISTORY_SECTION_DATA = {
  independence: {
    ...
    sections: [
      ...
      { notesCue: "“Government gets its power from the people…”", heading: "POWER FROM THE PEOPLE", text: "Government receives its authority from the people. This is popular sovereignty and consent of the governed." },
      { notesCue: "“The people may change or replace it.”", heading: "LIMITED GOVERNMENT", text: "Government may not use power however it wants. When it repeatedly violates rights, the people may change or replace it." },
  ...
  crisis: {
    ...
    sections: [
      ...
      { notesCue: "“The larger lesson was…”", heading: "THE DEEPER LESSON", text: "Liberty can be threatened by a government that is too powerful. It can also be threatened when government is too weak to protect rights, property, public safety, or the rule of law." }
    ],
  ...
  debate: {
    ...
    sections: [
      ...
      { notesCue: "“They disagreed about whether a weak or powerful government was more dangerous.”", heading: "THE SAME GOAL, DIFFERENT FEARS", text: "Both sides wanted to protect liberty and prevent tyranny. Federalists feared a government too weak to act. Anti-Federalists feared a national government powerful enough to abuse rights. They disagreed about which danger was greater." }
    ],
  ...
  rights: {
    ...
    teach: ["What happened in 1788 and 1789 that put the new government into operation?", "Why did Federalists promise to add written protections for individual rights?", "What are three freedoms or legal rights protected by the Bill of Rights?"]
  }
};
